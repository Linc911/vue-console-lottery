  ...
  <section class="lottery-users">
    ...
    <div class="table-list">
      ...
      >
        ...
        <el-table-column prop="unknown" label="直接下属" />
        <el-table-column prop="unknown" label="返水日期" />
        <el-table-column prop="unknown" label="返水批次" />
        <el-table-column prop="unknown" label="返水子批次" />
        <el-table-column prop="unknown" label="游戏分类" />
        <el-table-column prop="unknown" label="游戏玩法" />
        <el-table-column prop="unknown" label="有效注单" />
        <el-table-column prop="unknown" label="总投注" />
        <el-table-column prop="unknown" label="盈利金额" />
        <el-table-column prop="unknown" label="注单笔数" />
        <el-table-column prop="unknown" label="返水点数" />
