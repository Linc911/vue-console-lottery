  ...
  <section class="lottery-users">
    ...
    <div class="table-list">
      ...
      >
        ...
        <el-table-column prop="code" label="游戏编码" />
        <el-table-column prop="balls" label="球数类型" />
        <el-table-column prop="money" label="抽水起始注单金额" />
        <el-table-column prop="scale" label="抽水比例%" />
        <el-table-column prop="effect" label="是否有效" />
