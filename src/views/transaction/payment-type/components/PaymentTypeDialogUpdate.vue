...
<div class="dialog-update">
  <el-dialog :visible.sync="dialogVisible" title="修改支付类型配置" width="450px">
    <el-form :model="data" label-width="80px" size="small" ref="formUpdate">
      ...
      <el-form-item props="remark" label="备注">
        <el-input v-model="data.remark" type="textarea" rows="3" placeholder="备注" />
      </el-form-item>
    </el-form>
