<template lang="html">
  <el-dialog :visible.sync="dialogVisible" title="修改出款商户配置" width="760px">
    <el-form
      :model="formData"
      :rules="rules"
      label-width="100px"
...
export default {
  name: 'WithdrawAccountDialogUpdate',
  components: { FormSelect },
  mixins: [ dialogUpdateMixin ],
  data () {
    return {
      updateHttpAPI: 'updateWithdrawAccountItem',
  ...
  watch: {
    data () {
      this.idParams = { paymentMerchantId: this.data.paymentMerchantId }
    }
  }
}
</script>
