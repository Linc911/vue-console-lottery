  ...
  <el-dialog :visible.sync="dialogVisible" title="创建新优惠活动" width="760px">
    ...
    >
      ...
      <el-form-item prop="coverImg" label="封面图片">
        <el-input v-model.trim="formData.coverImg" placeholder="http://ip:port/img.jpg" />
      </el-form-item>

      <el-form-item prop="activityImg" label="活动内容图片">
        <el-input v-model.trim="formData.activityImg" placeholder="http://ip:port/img.jpg" />
      </el-form-item>
