      ...
      menu: [
        ...
        },
        {
          ...
          children: [
            ...
            { id: 'test0202', name: '会员账户核查', path: '/users/unset', icon: 'fa-cubes' },
            { id: 'test0203', name: '关键信息修改', path: '/users/unset', icon: 'fa-cubes' },
            { id: 'test0204', name: '会员分组管理', path: '/users/unset', icon: 'fa-cubes' },
            { id: 'test0205', name: '会员资料管理', path: '/users/unset', icon: 'fa-cubes' },
            { id: 'test0206', name: '会员报表统计', path: '/users/unset', icon: 'fa-cubes' },
            { id: 'test0207', name: '会员日志管理', path: '/users/unset', icon: 'fa-cubes' },
